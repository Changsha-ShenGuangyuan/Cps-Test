export default {
  ...
  doubleClickTest: 'Mouse double-click test',
  clicks: 'clicks',
  secClickTestTitle: '{sec} Second Click Test',
  spaceClickTest: 'Space Click Test',
  secSpaceTest: 'Second Space Test',
  secSpaceTestTitle: '{sec} Second Space Test',
  kohiClickTest: 'Kohi Click Test',
  typingTest: 'Typing Test',
  typingTestTitle: '{min} Minute Typing Test',
  ...
  tripleClickTest: 'Mouse triple-click test',
  ...
  testGuideDescription:
    'Spacebar Clicker - CPSTestGo platform guide, helping you quickly start testing spacebar click speed and reaction abilities',
  testFeatureRealTimeFeedback: 'Real-time Feedback',
  testFeatureHistoryRecords: 'History Records',
  testFeatureMultiLanguageSupport: 'Multi-language Support',
  testFeatureResponsiveDesign: 'Responsive Design',
  ...
  reactionTestDesc: 'Test your visual reaction speed, measuring the time from stimulus to reaction',
  ...
  spacebarClickerKeywords: 'spacebar clicker,click game,auto click,BUFF system,click accumulation',
