export default {
  ...
  testFeatureResponsiveDesign: '响应式设计',
  ...
  spaceFaq2A3: '适合：想从1秒过渡到更长测试的初学者需要评估短期稳定性的玩家作为日常训练的基准测试',
  spaceFaq2Q4: '2秒空格点击测试的练习方法？',
  spaceFaq2A4: '建议：每天做5组2秒测试，记录平均成绩关注后1秒是否明显下降结合1秒和5秒测试综合训练',
  // 5秒空格点击测试FAQ
  ...
  spaceFaq5A4: '观察指标：CPS提升：整体速度提高稳定性改善：后几秒衰减率降低点击曲线平滑：波动减少',
  // 10秒空格点击测试FAQ
  ...
  faqClick2A3: '适合：想从1秒过渡到更长测试的初学者需要评估短期稳定性的玩家作为日常训练的基准测试',
  faqClick2Q4: '2秒鼠标点击测试的练习方法？',
  faqClick2A4: '建议：每天做5组2秒测试，记录平均成绩关注后1秒是否明显下降结合1秒和5秒测试综合训练',
  // 5秒点击测试FAQ
  ...
  faqClick5A4: '观察指标：CPS提升：整体速度提高稳定性改善：后几秒衰减率降低点击曲线平滑：波动减少',
  // 10秒点击测试FAQ
  ...
  privacyThirdPartyServices1: '分析服务：我们使用Google Analytics等服务来分析网站流量和用户行为。',
